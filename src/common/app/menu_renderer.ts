...
export abstract class AppMenuRenderer<
  ContainerType,
  TextType,
  ImageType,
  MIC,
  PI extends PopupSubMenuItem<MIC, MIC>,
  LI extends MenuItem<MIC>,
  CI extends CheckedMenuItem<MIC>,
  MI extends MatchMenuItem<MIC>,
> extends MenuRendererCommon<
  ContainerType,
  TextType,
  ImageType,
  MIC,
...
> {
  ...
  constructor(
    ...
    this.eventContainer = renderer.createContainer({
      vertical: true,
      xExpand: true,
    });
    this.otherContainer = renderer.createContainer({
      vertical: true,
      xExpand: true,
    });
  }
  ...
  protected getDataFetchStatusContainer(
    text: string
  ): [ContainerType, TextType] {
    const r = this._renderer;
    const container = r.createContainer({
      xExpand: true,
