...
export class RNPopupSubMenuItem
  implements PopupSubMenuItem<ReactElementGenerator, ReactElementGenerator>
{
  ...
  constructor(
    ...
    renderer: Renderer<RNElement, RNElement, RNElement>,
  ) {
  ...
  get menu(): ReactElementGenerator {
    ...
    return () => {
      const [menu, menuContainer] = getPopupSubMenuItem(
        this._expanded,
        handler => {
      ...
      return React.createElement(
        ScrollView,
        { horizontal: true, contentContainerStyle: { flexGrow: 1 } },
        menu.element(),
      );
    };
  }
...
abstract class RNCheckedMenuItemCommon
  extends MatchMenuItemRenderer<RNElement, RNElement, RNElement>
  implements CheckedMenuItem<ReactElementGenerator>
{
  ...
  constructor(
    r: Renderer<RNElement, RNElement, RNElement>,
    checked: boolean,
...
export class RNCheckedMenuItem extends RNCheckedMenuItemCommon {
  ...
  protected addItemData(itemData: RNElement): void {
    this.r.addTextToContainer(itemData, {
...
export class RNMatchMenuItem
  extends RNCheckedMenuItemCommon
  implements MatchMenuItem<ReactElementGenerator>
{
